            ...
            <div class="container mx-auto md:px-0 ">
                <nav class="flex items-center justify-around">
                    ...
                    <div class="flex-1 text-right">
                        ...
                        @guest
                                <a class="text-white no-underline hover:underline hover:text-gray-300 p-3 mx-2" href="{{ route('login') }}">{{ __('Login') }}</a>
                            @if (Route::has('register'))
                                    <a class="text-white no-underline hover:underline hover:text-gray-300 p-3 mx-2" href="{{ route('register') }}">{{ __('Register') }}</a>
                            @endif
                        @else
